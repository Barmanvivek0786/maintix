  ...
  Widget build(BuildContext context) {
    ...
    final menuItems = [
      ...
      _MenuItem(
        ...
        iconColor: AppTheme.onSurfaceStrong,
    ...
    return Column(
      children: [
        ...
        // NOTE: Special Offer card moved to ProfileSpecialOfferWidget
        // (shown right below the Active Offer card on the profile screen).
